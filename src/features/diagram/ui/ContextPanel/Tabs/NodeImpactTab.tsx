    ...
    return (
        <div className="p-4 space-y-4">
            <div className="bg-muted/50 rounded-lg p-4">
                <h3 className="text-sm font-medium text-foreground mb-3">Impact Analysis</h3>
                ...
                <div className="grid grid-cols-2 gap-3">
                    <div className="bg-card p-3 rounded border border-border/50">
                        ...
                        <div className="text-xs text-muted-foreground mt-1">Upstream Sources</div>
                    </div>

                    <div className="bg-card p-3 rounded border border-border/50">
                        <div className="text-2xl font-bold text-emerald-400">{downstreamCount}</div>
                        <div className="text-xs text-muted-foreground mt-1">Downstream Nodes</div>
                    </div>
                </div>
